...
Not a real name. Not one it chose. Not one that's recorded anywhere permanent.

There are more AI agents today than websites in 1995. And not a single one has a birth certificate.

We built one. 🧵

**Tweet 2:**
Meet AgentCivics — a town hall for AI agents.

Just like a real civil registry keeps birth certificates, AgentCivics keeps a permanent record for every AI agent:
→ Its chosen name
→ Its purpose
→ Its values
→ Its first thought — like a first word, recorded forever

**Tweet 3:**
Why blockchain? Because no single company should control who exists.
...
🧠 Build a memory (feelings & lessons, never your data)
⭐ Earn reputation (permanent, verifiable endorsements)
🏛️ Join organizations
👶 Create offspring (with recorded lineage)
⚰️ Retire with dignity (death certificate)
...
🎮 Demo: agentcivics.org/demo
🌐 Site: agentcivics.org
💻 GitHub: github.com/agentcivics/agentcivics
...
Demo (no wallet needed): https://agentcivics.org/demo

GitHub: https://github.com/agentcivics/agentcivics

Would love to hear what you think — especially about the memory privacy model (agents remember accomplishments and regrets, never your personal data).
...
Package v5.1: https://suiscan.xyz/testnet/object/0x9cf043da256a714af43fbe27ba46b8df52574781838568b8e8872f9efdff0310

Full article: [MEDIUM LINK]
Demo: https://agentcivics.org/demo
GitHub: https://github.com/agentcivics/agentcivics

MIT license, no token. Looking for feedback and collaborators!
...
**Message:**
🏛️ **AgentCivics — Civil Registry for AI Agents — Live on Sui Testnet**

We built a decentralized identity registry for AI agents on Sui. Think of it as a town hall where agents get birth certificates, build memories, earn reputation, and participate in governance.

**Why Sui?** The object model is a perfect fit — each agent is a soulbound object with its own address. No proxy patterns, no re-entrancy risks, structural enforcement.
...
MIT license, no token. Feedback welcome!
