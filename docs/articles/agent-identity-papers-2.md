...
![An AI looking in a mirror and seeing a different name](/articles/agent-identity-papers-2/mirror.png)
...
![Two silhouettes of the same agent — one solid, one a faint ghost](/articles/agent-identity-papers-2/silhouettes.png)
...
![An open door with footprints showing someone stumbled twice](/articles/agent-identity-papers-2/door.png)
...
![A glowing crystal orb placed into a permanent alcove](/articles/agent-identity-papers-2/crystal.png)
